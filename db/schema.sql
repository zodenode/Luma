-- AI Coaching MVP — Postgres schema (from engineering plan).
-- File-backed JSON store is the default runtime for this repo; this DDL is the
-- reference schema for production deployment and contract tests.
